                    ...
                    <div className="grid grid-cols-1 md:grid-cols-1 gap-6 mt-8">
                        <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
                            ...
                            <div className="space-y-4 text-gray-300">
                                <div>
                                    <h4 className="font-semibold">Web Developer | Freelance (Mar 2025 - Ongoing)</h4>
                                ...
                                <div>
                                    <h4 className="font-semibold">Junior Data Analyst | QueTee Ent., Remote (July 2024 - Mar 2025)</h4>
                                    <ul className="list-disc ml-4">
                                ...
                                <div>
                                    <h4 className="font-semibold">Data Analyst | MAQ B2B Solutions, Remote (Jan 2024 - June 2024)</h4>
                                    <ul className="list-disc ml-4">
                                ...
                                <div>
                                    <h4 className="font-semibold">Unity Developer Intern | Softic Solutions, Remote (Sep 2023 - Dec 2023)</h4>
                                    <ul className="list-disc ml-4">
                                ...
                                <div>
                                    <h4 className="font-semibold">Shopify Product Listing | Freelance (Aug 2023)</h4>
                                    <ul className="list-disc ml-4">
                                ...
                                <div>
                                    <h4 className="font-semibold">Product & Socials Manager | Cheelings, Remote (Mar 2023 - July 2023)</h4>
                                    <ul className="list-disc ml-4">
                                ...
                                <div>
                                    <h4 className="font-semibold">Sales Administrator | Kiddy School, Remote (Feb 2023)</h4>
                                    <ul className="list-disc ml-4">
                                ...
                                <div>
                                    <h4 className="font-semibold">Content Writer | Freelance (Jan 2022 - Dec 2023)</h4>
                                    <ul className="list-disc ml-4">
